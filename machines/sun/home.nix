...
in {
  ...
  config = {
    ...
    programs = {
      bash = {
        enable = true;
        initExtra = builtins.readFile ../../modules/shell/bash/sun/.bashrc;
        # shellAliases =
        #   builtins.readFile ../../modules/shell/bash/sun/.bash_aliases;
        logoutExtra =
          builtins.readFile ../../modules/shell/bash/sun/.bash_logout;
        profileExtra =
          builtins.readFile ../../modules/shell/bash/sun/.bash_profile;
        enableAutojump = true;
      };
    };
